...
const AuthenticatedAppContent = ({ appData, navigation, showSplash }: any) => {
  ...
  return (
    <div className="min-h-[100dvh] w-full font-sans flex flex-col relative bg-slate-50">
      ...
      {view === 'students' && (
        <button
            className="fixed bottom-20 right-6 z-40 bg-indigo-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-indigo-700 transition-all active:scale-95 cursor-pointer"
